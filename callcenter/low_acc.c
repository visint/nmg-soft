...
//memcpy(olp,buf,pInfoSet_size);
        ...
        printf("mode=%d line=%d rule=%d ret_mode=%d rx1=%d rx2=%d tx=%d l1=%d l2=%d alm=%d rx1_led=%d rx2_led=%d tx_led=%d rx1_wl=%d rx2_wl=%d tx_wl=%d\n",olp->mode,olp->line,olp->rule,olp->ret_mode,olp->rx1_power,olp->rx2_power,olp->tx_power,olp->l1_power,olp->l2_power,olp->tx_power,olp->rx1_led,olp->rx2_led,olp->tx_led,olp->rx1_wave_len,olp->rx2_wave_len,olp->tx_wave_len);
}
